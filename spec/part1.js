(function() {
  ...
  describe('Part I', function() {
    ...
    describe('last', function() {
      ...
      it('should accept an index argument', function() {
        expect(_.last([1, 2, 3], 2)).to.eql([2, 3]); // check referrence for returned value format when n > 1
      });
    ...
    describe('indexOf', function() {
      ...
      it('returns the first index that the target can be found at when there are multiple matches', function() {
        var numbers = [10, 20, 30, 20, 40, 10, 50];
        expect(_.indexOf(numbers, 20)).to.equal(1);
      });
    });
    ...
    describe('uniq', function() {
      ...
      it('should produce a brand new array instead of modifying the input array', function() {
        ...
        expect(uniqueNumbers).to.not.eql(numbers);
      });
    });
    ...
    describe('reduce', function() {
      ...
      it('should reduce values with accumulator when accumulator is defined as a falsy value but not undefined', function() {
        var result = _.reduce([1, 2, 3], function(memo, item) {
          return memo * item;
        }, 0);
